defmodule BattlelineWeb.UserAuthTest do
  use BattlelineWeb.ConnCase, async: true

  alias Battleline.Accounts
  alias BattlelineWeb.UserAuth
  import Battleline.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BattlelineWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BattlelineWeb.Endpoint.subscribe(live_socket_id)
